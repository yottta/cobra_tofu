...
// commandHelp is a function that compiles generic help messages for any of the commands and their sub commands.
// This is configured only on the root command and used by any other sub commands.
//
// This is here strictly as a POC to showcase that it's possible to customise this to match
// OpenTofu's needs.
